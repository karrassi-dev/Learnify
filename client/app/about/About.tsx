    ...
    <div className="text-black dark:text-white">
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than Learnify, the premier programming community
          dedicated to helping new programmers achieve their goals and reach
          their full potential.
          <br />
          <br />
          As the founder and CEO of Learnify, I know firsthand the challenges
          that come with learning and growing in the programming industry.
          That&apos;s why I created Learnify &ndash; to provide new
          ...
          <br />
          <br />
          At Learnify, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          But Learnify is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With Learnify by your side, there&apos;s nothing standing between
        ...
        <br />
        <span className="text-[22px]">Karrassi Hamza</span>
        <h5 className="text-[18px] font-Poppins">
          Founder and CEO of Learnify
        </h5>
        <br />
        <br />
        <br />
